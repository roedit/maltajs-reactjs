...
describe('Hoek', function () {
    ...
    describe('#loadDirModules', function () {
        ...
        it('should load js from directory', function (done) {

            var target = {};
            Hoek.loadDirModules(__dirname + '/js', ['test2'], target);
        ...
        it('should list js from directory into function', function (done) {

            var target = {};
            Hoek.loadDirModules(__dirname + '/js', ['test2'], function (path, name, capName) {
