...
grunt.initConfig({
  concat: {
    basic: {
      src: ['src/maltaJsApp.js'],
      dest: 'dist/basic.js'
    },
    extras: {
      src: ['src/maltaJsApp.js', 'src/extras.js'],
...
grunt.initConfig({
  concat: {
    basic_and_extras: {
      files: {
        'dist/basic.js': ['src/maltaJsApp.js'],
        'dist/with_extras.js': ['src/maltaJsApp.js', 'src/extras.js']
      }
    }
  }
});
...
grunt.initConfig({
  ...
  concat: {
    basic: {
      src: ['<%= dirs.src %>/maltaJsApp.js'],
      dest: '<%= dirs.dest %>/basic.js'
    },
    extras: {
      src: ['<%= dirs.src %>/maltaJsApp.js', '<%= dirs.src %>/extras.js'],
